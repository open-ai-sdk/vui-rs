...
// keeping only matches, best first. This is a lightweight stand-in for a
// dedicated fuzzy-search library: deliberately small and good-enough for command
// palettes, selects, and autocomplete over hundreds of items, not a million-row
// search engine.
 ...
 */
export function fuzzyFilter<T>(query: string, items: readonly T[], key: (item: T) => string): Array<FuzzyRanked<T>> {
