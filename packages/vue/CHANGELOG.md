...
- 1a7ab76: Markdown tables: size columns synchronously from the live terminal width instead
...
- f084a39: Markdown tables: draw the frame, header/row rules and cell separators with the
