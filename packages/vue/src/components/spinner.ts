...
import { type PropType, computed, defineComponent, h, shallowRef, watch } from '@vue/runtime-core'
...
export const VuiSpinner = defineComponent({
  ...
  setup(props) {
    ...
    watch(() => [frames.value.length, props.interval] as const, restart, { immediate: true })
