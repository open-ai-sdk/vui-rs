<template>
  ...
  >
    ...
    <text :fg="MUTED">
      encoding <b :fg="GREEN">{{ encoding }}</b> ·
      half-block works everywhere · set <b :fg="GREEN">VUI_IMG_ENC=kitty</b> on a
      Kitty/Ghostty terminal for native graphics ·
      <b :fg="RED">Esc</b> quit
    </text>
    <text> </text>
    ...
    <text> </text>
    <text :fg="MUTED"
      >Left is fetched over the network (an <b :fg="TEXT">http(s)</b> src is
      downloaded once, then decoded); right is a file bundled with the app. Each is
      fitted (aspect preserved) to its box.</text
    >
  </box>
</template>
